...
public class GeodeJavaPairRDDFunctions<K, V> {
     ...
     * @return JavaPairRDD&lt;Tuple2&lt;K, V>, V2>
     */
    public <K2, V2> JavaPairRDD<Tuple2<K, V>, V2> joinGeodeRegion(String regionPath,
                                                                  Function<Tuple2<K, V>, K2> func,
                                                                  GeodeConnectionConf connConf) {

        GeodeJoinRDD<Tuple2<K, V>, K2, V2> rdd = rddf.joinGeodeRegion(regionPath, (Function1<Tuple2<K, V>, K2>) func, connConf);
        ClassTag<Tuple2<K, V>> kt = fakeClassTag();
        ClassTag<V2> vt = fakeClassTag();
        return new JavaPairRDD<>(rdd, kt, vt);
    }
    ...
    public <K2, V2> JavaPairRDD<Tuple2<K, V>, Option<V2>> outerJoinGeodeRegion(
        ...
        GeodeOuterJoinRDD<Tuple2<K, V>, K2, V2> rdd = rddf.outerJoinGeodeRegion(regionPath, (Function1<Tuple2<K, V>, K2>) func, connConf);
        ClassTag<Tuple2<K, V>> kt = fakeClassTag();
        ClassTag<Option<V2>> vt = fakeClassTag();
        return new JavaPairRDD<>(rdd, kt, vt);
    }
