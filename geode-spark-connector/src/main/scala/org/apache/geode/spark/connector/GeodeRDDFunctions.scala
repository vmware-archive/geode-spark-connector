...
import org.apache.geode.spark.connector.internal.rdd.{GeodeJoinRDD, GeodeOuterJoinRDD, GeodeRDDWriter}
...
/**
  ...
  * use these functions.
  */
class GeodeRDDFunctions[T](val rdd: RDD[T]) extends Serializable {
