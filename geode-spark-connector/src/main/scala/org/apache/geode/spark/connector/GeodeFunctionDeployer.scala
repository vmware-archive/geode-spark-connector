...
import org.apache.commons.httpclient.methods.multipart.{FilePart, MultipartRequestEntity, Part}
import org.apache.commons.httpclient.HttpClient
import org.apache.geode.spark.connector.internal.LocatorHelper.getClass
...
class GeodeFunctionDeployer(val httpClient:HttpClient)  {
  ...
  def commandLineRun(args: Array[String]):Unit = {
    ...
    if (args.length < 2) {
      LOG.info("JMX Manager Host and Port (example: localhost:7070):")
      ...
      LOG.info("Location of geode-functions.jar:")
